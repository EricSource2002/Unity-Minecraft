...
public class WaterChunkObject : MonoBehaviour
{
    //chunk size
    public const float waterHeight = Chunk.chunkHeight*0.46f;
    ...
    public void SetLocs(BlockType[,,] blocks, Chunk chunk)
    {
        int y;
